"""Gymnasium-compatible environment for Connections with configurable mistakes."""
...
from src.dqn.actions import get_action_from_idx, get_action_mask, NUM_ACTIONS, WORDS_PER_PUZZLE, GROUP_SIZE
from src.dqn.reward import compute_reward
...
class ConnectionsEnv:
    ...
    def __init__(self, data_loader: DataLoader = None, max_mistakes: int = 4, reward_weights: Dict[str, float] = None):
